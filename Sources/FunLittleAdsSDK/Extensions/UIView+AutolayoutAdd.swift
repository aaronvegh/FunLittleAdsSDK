...
extension UIView {
    enum LayoutMode {
        ...
        func apply(to view: UIView, superview: UIView) {
            constraints(for: view, superview: superview).activate()
        }

        func constraints(for view: UIView, superview: UIView) -> [NSLayoutConstraint] {
            switch self {
            case .fill:
    ...
    func addSubview(_ view: UIView, layoutMode modes: LayoutMode...) {
